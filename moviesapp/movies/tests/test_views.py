...
class TestMovieViews(TestCase):
    ...
    def test_detail(self):
        resp = self.client.get('/movies/detail/8/') #mal parseada la url
        self.assertEqual(resp.status_code, 200)
    ...
    def test_create(self):
        ...
        self.assertEqual(resp.status_code, 200)
        #self.assertContains(resp, 'form', 'title', 'Testing in Production - The Movie')
        #self.assertContains(resp, 'The movie created successfully') indagar estos self
    ...
    def test_create_field_required(self):
        ...
        #self.assertContains(resp, 'The creation has failed') indagar sobre estos self
    ...
    def test_update(self):
        ...
        #self.assertContains(resp, 'form', 'director', 'Jose Matus')
        self.assertEqual(resp.status_code, 200)
        #self.assertContains(resp, 'The movie updated successfully') indagar los self
    ...
    def test_delete(self):
        ...
        self.assertEqual(resp.status_code, 200)
        #self.assertContains(resp, 'The movie deleted successfully') indagar
